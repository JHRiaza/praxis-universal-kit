...
a = Analysis(
    ...
    hiddenimports=['customtkinter', 'smtplib', 'ssl', 'email', 'email.message', 'submission', 'diagnostics', 'adapters.openclaw_telemetry', 'adapters.codex_telemetry', 'adapters.cowork_telemetry'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
